...
public class CommandLine extends Panel implements KeyListener{
...
protected void commandControl(KeyEvent ke){
    ...
    if(c=='\n'){
        ...
        if(commandEnter.equals("")){
            ...
            tempCommand=tempCommand+1;
            //System.out.println(II+" "+commandNum);
        }
...
/////////////////////////////FIND FILE///////////////////////////////
                    else if (commandEnter.startsWith("find") || commandEnter.startsWith("find")) 
                    {
                        ...
                        while (tokenizer.hasMoreTokens()) {
                            ...
                            }catch(Exception e){ta.append("Error: Can't execute command 'fine'\n");}
                        }
...
////////////////////////////////////////////////////////////////////
            ...
            else if(commandEnter.startsWith("show") || commandEnter.startsWith("show"))
            {
                ...
                while (tokenizer.hasMoreTokens()) {
                    ...
                    try{
                        ...
                        String cannotShowFiles="";
                        cannotShowFiles=token;
                        ta.append("Error: Can't show file'"+cannotShowFiles+"'\n'");
                    }
                }
        ...
        else if(commandEnter.startsWith("local") || commandEnter.startsWith("local"))
        {
            ...
            try{
                ...
                ta.append("     local -uk (UnitedKingdom)\n");
    ...
    /////////////////////OS INFORMATION////////////////////////
        ...
        ta.append("OS Registration: "+usr_Name+"\n");
    ...
    //////////////////////////////////////////////////////////////
    else if(commandEnter.equals("tokenizer")){
        ta.append("\n");
        ta.append(currentPath+prompt);
        tf.requestFocus();
    }
    ...
    ////////////////////HELP////////////////////////
        ...
        ta.append(commandEnter+"\n");
        ta.append("-----------------|-----------------------------------|-------------------\n");
        ta.append(" COMMAND         | MEANING                           | EXAMPLR\n");
        ta.append("-----------------|-----------------------------------|-------------------\n");
        ...
        ta.append("urlinfo               |Gives URL information            |  urlinfo https://www.yahoo.com\n");     
        ...
        ta.append("kill               |Delets file            |  kill file1.txt file2.txt\n");     
        ta.append("save               |Saves file in edit mode            |  save file1.txt file2.txt\n");     
        ta.append("local               |Saves file in edit mode            |  local\n");     
...
public static void main(String args[]) throws Exception{
    ...
    CommandLine nd=new CommandLine();
    myFrame.add(nd);
